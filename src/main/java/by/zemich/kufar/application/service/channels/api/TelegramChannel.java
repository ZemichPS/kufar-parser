...
public abstract class TelegramChannel implements AdvertisementPublisher, Notifiable {
    ...
    protected TelegramChannel(PhotoMessenger<SendPhoto> photoMessenger, PostManager postManager) {
